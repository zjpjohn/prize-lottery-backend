...
public class UriPathContainer implements PathContainer {

    private static final MultiValueMap<String, String>    EMPTY_PARAMS = new LinkedMultiValueMap<>();
    private static final PathContainer                    EMPTY_PATH   = new UriPathContainer("", Collections.emptyList());
    ...
    private UriPathContainer(String path, List<Element> elements) {
        this.path     = path;
    ...
    public static PathContainer parsePath(String path) {
        return UriPathContainer.createFromUrlPath(path, Options.HTTP_PATH);
    }
    ...
    static PathContainer createFromUrlPath(String path, Options options) {
        ...
        return new UriPathContainer(path, elements);
    }
    ...
    static PathContainer subPath(PathContainer container, int fromIndex, int toIndex) {
        ...
        return new UriPathContainer(path, subList);
    }
