...
public class Pl3Com7CombineExe implements CombineExecutor {
    ...
    public List<Pair<String, Long>> execute(ComCombineCalcCmd cmd) {
        ...
        List<Pl3IcaiDataVo> dataList = mapper.getPl3RankedDataList(Pl3Channel.COM7.getChannel(), cmd.getPeriod(), last, 20);
        return dataList.stream()
                       .map(Pl3IcaiPo::getCom7)
