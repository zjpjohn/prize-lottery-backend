...
public interface IPlsLottoCommandService {

    Pl3ForecastVo lookupForecast(Long userId, String masterId);
    ...
    NumberThreeCensusVo getTypeLeveledCensusDetail(Long userId, ChartType type, Integer level);

    FeeDataResult<NumberThreeCensusVo> getTypeLeveledCensusDetailV1(Long userId, ChartType type, Integer level);
    ...
    N3Comb5StatsVo comb5Stats(N3DanFilterQuery query);
