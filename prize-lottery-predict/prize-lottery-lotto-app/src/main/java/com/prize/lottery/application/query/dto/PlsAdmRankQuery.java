...
public class PlsAdmRankQuery extends PageQuery {

    private static final long serialVersionUID = 5570932918474480810L;
    ...
    public PageCondition from() {
        ...
        return super.from().setParam("last", LotteryEnum.PL3.lastPeriod(period));
    }
