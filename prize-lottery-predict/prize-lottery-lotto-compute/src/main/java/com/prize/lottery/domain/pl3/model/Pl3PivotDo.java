...
@Data
@NoArgsConstructor
public class Pl3PivotDo implements AggregateRoot<Long> {

    private static final long serialVersionUID = -6483299841153214282L;
    ...
    public Pl3PivotDo(String period,
                      String best,
                      String second,
                      String quality,
